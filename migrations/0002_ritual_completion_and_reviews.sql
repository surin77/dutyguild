ALTER TABLE cleaning_cycles ADD COLUMN completed_at TEXT;
ALTER TABLE cleaning_cycles ADD COLUMN feedback_requested_at TEXT;

ALTER TABLE cycle_assignments ADD COLUMN completed_at TEXT;
